...
Remove Machine 2 from time series

Update ingredient list to real measures(fl. oz.)

Predict 3 things, Overall revenue, drink consumption, ingredient usage
...
```{r recipie list}
recipes <- tribble(
  ~coffee_name,                  ~coffee, ~milk, ~chocolate, ~caramel, ~sugar, ~tea, ~vanilla,
